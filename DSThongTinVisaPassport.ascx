                    ...
                    <core:iHRPCoreGrid ID="dtgListGiayPhepLaoDong" GridLines="None" Width="100%" Height="500px" runat="server"
                        ...
                        <MasterTableView GroupLoadMode="Client" Width="100%" CommandItemDisplay="Top" AllowMultiColumnSorting="true">
                            ...
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                ...
                                <telerik:GridBoundColumn SortExpression="EffectiveDate" Visible="false" UniqueName="EffectiveDate" DataField="EffectiveDate" DataFormatString="{0: dd/MM/yyyy}"
                                ...
                                <telerik:GridBoundColumn SortExpression="Address" Visible="false" UniqueName="Address" DataField="Address"
                                    HeaderText="Address">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn SortExpression="OtherInfo1" Visible="false" UniqueName="OtherInfo1" DataField="OtherInfo1"
                                    HeaderText="OtherInfo1">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn SortExpression="OtherInfo2" Visible="false" UniqueName="OtherInfo2" DataField="OtherInfo2"
                                    HeaderText="OtherInfo2">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn SortExpression="OtherInfo3" Visible="false" UniqueName="OtherInfo3" DataField="OtherInfo3"
                                    HeaderText="OtherInfo3">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn SortExpression="Fee" Visible="false" UniqueName="Fee" DataField="Fee"
                                    HeaderText="Fee">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                </telerik:GridBoundColumn>
                                <%--RlogID 25189 - KPMG_V34--%>
