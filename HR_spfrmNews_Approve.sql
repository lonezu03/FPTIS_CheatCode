USE [iHRP_V34_KPMG]
GO
/****** Object:  StoredProcedure [dbo].[HR_spfrmNews_Approve]    Script Date: 5/15/2026 3:06:50 PM ******/
SET ANSI_NULLS ON
GO
		...
		BEGIN
			...
			BEGIN
						...
						OUTER APPLY(
							...
							FROM dbo.HR_tblEmpCV_CapNhat (NOLOCK) RC /*Tamnb KPMG_IHRP_2025_PM-383?filter=54427*/
